...
# Set highlight color to the default blue color
...
# Modifying chrome here will show a warning message:
# "This computer is being managed by your organization"
